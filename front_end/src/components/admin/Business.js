import { IoMdClose } from "react-icons/io"; import React, { useState } from "react";
...
const business = [
    {
        ...
        ngayThanLap: "2020-01-01",
        moTa: "Công ty chuyên về công nghệ.",
        id_loaitaikhoan: 1,
        matKhau: "password123",
        ngayTao: "2020-01-01",
    },
                        ...
                        {currentData.map((businesses) => (
                            ...
                            >
                                ...
                                <td className="px-6 py-3">
                                    <span
                                        className={`px-2 py-1 text-xs font-medium inline-block rounded-full ${businesses.trangThai === "Đã Duyệt"
                                ...
                                <td className="px-6 py-3 flex items-center ">
                                    <select
                                        ...
                                        onChange={(e) =>
                                            handleStatusChange(businesses.id_congTy, e.target.value)
                                        }
                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                        <div className="text-center">
                            ...
                            />
                            <h3 className="text-xl font-semibold mb-2">{isModalOpen.tenCongTy}</h3>
                            <p className="text-gray-500 text-sm mb-4">{isModalOpen.nganhnghe}</p>
                        </div>
                        <div className="text-left">
                            ...
                            <p className="mb-2">
                                <strong>Số Lượng Nhân Viên:</strong> {isModalOpen.soLuongNhanVien}
                            </p>
                            <p className="mb-4">
                    ...
                    <div className="relative bg-white py-6 px-12 rounded-lg shadow-lg w-1/2">
                        ...
                        <div className="text-center">
                            <img
                                ...
                                className="w-24 h-24 rounded-full mx-auto mb-4 border border-gray-300"
                            />
                            <h3 className="text-xl font-semibold mb-2 text-orange-600">{isModalOpen.tenCongTy}</h3>
                            <p className="text-gray-900 text-sm mb-4 text-green-600">{isModalOpen.nganhnghe}</p>
                        </div>
